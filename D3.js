...
while (count < starWarsCharacters.length) {
  totalWeight += starWarsCharacters[count].mass;
  count++;
}
...
} else if (totalWeight > 500 && totalWeight < 700) {
...
*/
const newStarWarsCharacter = structuredClone(starWarsCharacters);
console.log(starWarsCharacters);
for (i = 0; i < newStarWarsCharacter.length; i++) {
  if (newStarWarsCharacter[i].gender === "n/a") {
    newStarWarsCharacter[i].gender = "robot";
  }
}
